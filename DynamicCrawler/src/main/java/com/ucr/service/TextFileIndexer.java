  ...
  public static void main(String[] args) throws IOException {
    ...
    while (!s.equalsIgnoreCase("q")) {
      try {
        ...
        Query q = new QueryParser("content", analyzer).parse(s);
  ...
  public void indexFileOrDirectory(String fileName) throws IOException {
    ...
    for (File f : queue) {
      ...
      try {
        ...
        doc.add(new TextField("content", fr));
        //doc.add(new StringField("url", lastLine.split("~")[0], Field.Store.YES));
        //doc.add(new StringField("title", lastLine.split("~")[1], Field.Store.YES));
